...
def sum_or_product(a: int, b: int):
...
def remove_chars(word: str, n: int):
    return word[n:]
...
def count_occurence(phrase: str, find: str):
...
def tax_calculation(income: int):
    tax = 0
    if income > 20000:
